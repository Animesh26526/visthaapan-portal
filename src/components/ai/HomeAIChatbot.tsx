...
export const HomeAIChatbot: React.FC = () => {
  ...
  const suggestionChips = [
    ...
    'How does the MILP mathematical relocation engine work?',
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-[11px] text-slate-300">
              Conversational Disaster Relocation Intelligence • Team KyuNahiHoRahiCoding for SIH
            </p>
          </div>
        </div>
          ...
          <div className="flex items-start gap-2.5 justify-start">
            ...
            <div className="bg-white border border-slate-200 rounded-2xl rounded-tl-xs p-3 shadow-2xs">
              <div className="flex items-center gap-1.5 text-slate-500 text-xs font-mono">
                ...
                <span className="ml-1 text-[11px]">Gemini 3.5 thinking...</span>
              </div>
            </div>
          </div>
        )}
      ...
      <div className="p-3 bg-white border-t border-slate-200 shrink-0">
        ...
        >
          <input
            ...
            placeholder="Ask anything about VISTHAAPAN, Chamoli evacuations, or MILP models..."
            disabled={isTyping}
